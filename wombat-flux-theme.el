(deftheme wombat-flux
  "A modification of wombat for use with f.lux.")
...
(custom-theme-set-faces
 ...
 '(custom-invalid ((t (:background "black" :foreground "black"))))
 '(ido-indicator ((t (:background "red1" :foreground "black"))))
 '(org-agenda-dimmed-todo-face ((t (:foreground "color-241"))))
 '(org-mode-line-clock-overrun ((t (:background "red1" :foreground "black"))))
 '(org-date ((t (:foreground "color-94" :underline t))))
 '(show-paren-mismatch ((t (:background "purple" :foreground "grey25"))))
 '(ido-only-match ((t (:background "tan" :foreground "ForestGreen")))))

(provide-theme 'wombat-flux)
