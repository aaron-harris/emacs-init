...
;;;=========================
;; For messages generated by `load', suppression is achieved by
;; forcing the third (NOMESSAGE) parameter to be non-nil.
(defmacro aph/silence-load-messages (&rest body)
  "Execute BODY, suppressing all messages from `load'."
  (declare (debug t)
           (indent 0))
  `(aph/with-advice
       ((#'load
